  ...
  return (
    ...
    <div className="d-flex p-5">
      <Add setAddVideoStatus={setAddVideoStatus} />
        <h5 className='ms-auto'><Link to={'/watchhistory'} style={{textDecoration:'none', color:'white'}}><span className='hide'>Watch History</span><FontAwesomeIcon icon={faClock} /></Link> </h5>
    </div>
